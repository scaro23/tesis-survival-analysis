...
# Survival analysis
This repository contains the source code developed for the work entitled "Cytogenetic and molecular factors associated with overall and event-free survival in pediatric B-cell acute lymphoblastic leukemia" (ES: Factores citogenéticos y moleculares asociados a la supervivencia global y libre de eventos en leucemia linfoblástica aguda tipo B pediátrica).
## Content
